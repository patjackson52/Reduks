...
class MiddlewareTest {
    ...
    fun actions_should_be_run_through_a_stores_middleware() {
        ...
        assertEquals(store.state, TestState())
    ...
    fun actions_should_pass_through_the_middleware_chain_in_the_correct_order() {
        ...
        assertEquals(store.state, TestState("howdy!"))
        assertEquals(counter, 2)
        assertEquals(order, listOf("first", "second", "third"))
    }

    /* TODO rewrite this in pure kotlin
    @Test
    ...
    */
    ...
    fun async_actions_should_be_able_to_send_new_actions_through_the_entire_chain() {
        ...
        assertEquals(order, listOf("first", "second", "first", "second"))
    }
